...
class ViT(nn.Module):
    ...
    def patchify(self, images):
        ...
        images = images.unfold(2, self.patch_dim, self.patch_dim).unfold(3, self.patch_dim, self.patch_dim)
        images = images.reshape(images.shape[0], -1, self.patch_dim * self.patch_dim * 3)
